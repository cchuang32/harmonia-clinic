...
const types = [
  ...
  },
  {
    icon: 'iv',
    title: 'PRP 再生注射治療',
    desc: '抽取自己的靜脈血，經離心分離出血小板濃度較高的血漿層，再注射到病灶部位。材料同樣來自本人，沒有排斥的問題。抽血量、注射次數與間隔會因人而異，是否適合須由醫師評估後說明。',
  },
  {
    icon: 'target',
    title: '超音波導引定位',
    desc: '注射全程以超音波即時定位，醫師看得到針尖走到哪裡，能避開血管與神經，把材料送到真正需要的位置。相較於憑手感施打，位置更明確，也能減少不必要的疼痛。',
  },
];
...
<section class="page-head">
  <div class="wrap">
    ...
    <p>兩種再生注射，材料都來自你自己的身體。這一頁把「東西從哪裡取、怎麼打、當天會發生什麼事」寫清楚，讓你在決定之前就先知道全部流程。</p>
  </div>
</section>
...
`;
  ...
  return {
    ...
    description: `${site.nameZh}的自體骨髓再生注射與 PRP 再生注射衛教說明：材料取自本人、超音波導引定位，從門診評估、採集、注射到回診追蹤的完整流程，以及注射後注意事項與看診前要告知醫師的狀況。`,
    active: '/regeneration/',
