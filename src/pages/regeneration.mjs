...
const types = [
  {
    icon: 'syringe',
    title: '自體骨髓再生注射治療',
    desc: '自體骨髓再生治療，是抽取自己少量的骨髓液，不經離心處理，不加入抗凝劑，再直接注射到受傷或疼痛的部位，利用骨髓中原有的細胞與生長因子，幫助身體啟動修復。因為使用的是自己的骨髓，不會有異體排斥的問題。至於骨髓從哪裡抽、需要治療幾次、多久一次，會依每個人的病況而不同，由醫師評估後為您說明。',
  },
  {
    icon: 'iv',
    title: 'PRP 再生注射治療',
  ...
  },
  {
    icon: 'target',
    title: '超音波導引定位',
    desc: '注射全程以超音波即時定位，醫師看得到針尖走到哪裡，能避開血管與神經，把生長因子送到真正需要的位置。相較於憑手感施打，位置更明確，也能減少不必要的傷害。',
  },
];
