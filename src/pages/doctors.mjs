...
const clinicNotes = [
  {
    ...
    desc: '同樣是膝蓋痛，可能和關節、肌腱、韌帶、神經或其他原因有關，疼痛來源不同，處置策略也可能不同。我會先詢問病史並做理學檢查，再視情況安排 X 光、超音波或其他檢查。',
  },
  {
    icon: 'target',
    title: '注射，全程看著針走',
    desc: '對適合超音波導引的關節或軟組織注射，我會在影像下觀察針尖與周邊重要構造。這是麻醉科訓練留給我最實用的東西。不憑手感，而是看著針尖到哪裡，避開不該碰的地方，把生長因子送到真正需要的位置。',
  },
  {
    icon: 'eye',
    title: '把螢幕轉過來給你看，把看到的說給你聽',
    desc: '檢查時，我會把影像轉過來一起看，說明哪些是確定發現、哪些只是可能相關。了解目前知道什麼、還不知道什麼，才能一起做出適合你的決定。',
  },
];
...
// ---------------------------------------------------------------------------
const learning = {
  intro: '醫療一直在變，尤其疼痛治療與影像導引技術這幾年變化很快。我每年固定參加繼續教育與實作課程，也在台灣區域麻醉暨止痛醫學會的工作坊擔任講師。',
  lecturing: [
