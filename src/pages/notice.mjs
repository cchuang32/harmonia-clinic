...
const rules = [
  ...
  {
    q: '已看診過的病人，診斷書與證明可請親友代領',
    a: '已開立完成的診斷書或各式證明，可由親友持<strong>病人健保卡及代領人身分證件</strong>代為領取。',
  },
  {
...
const notes = [
  ...
  '未帶健保卡或健保卡無法讀取時，需先收取<strong>押金 1,000 元</strong>，並請於 10 日內補卡退費。更重要的是，我們將<strong>無法查詢您的雲端用藥與檢查紀錄</strong>，這會直接影響用藥安全與治療判斷，所以請盡量隨身攜帶。',
  '<strong>已預約的病人，請於該診次結束前至少 15 分鐘完成報到</strong>，逾時將無法為您看診，敬請見諒。',
  '預約後若無法前來，請提前來電取消，把名額留給其他等候的病人。',
  '<strong>累計兩次預約未到且未事先取消，將暫停預約掛號一個月</strong>，該期間仍可現場掛號。名額有限，未到的時段等於讓其他等候的病人白白錯過。',
...
<section class="section section--tint">
  <div class="wrap measure">
    ...
    <div class="article-notice notice-callout">
      ...
      <p>看診順序由現場櫃檯人員統一安排，會視當診人數，以及是否需要檢查或處置而調整，並非一律照掛號先後叫號。完成掛號後，請在候診區稍候叫號，勿逕自進入診間詢問。這樣安排，是為了讓每一位病人都有完整的看診時間。</p>
    </div>
