...
// 入鏡的汽機車車牌（與車內人物）已模糊處理。換照片時也要檢查這一點。
// ---------------------------------------------------------------------------
const exterior = [
  {
    src: '/assets/img/exterior-1-street.jpg',
    alt: '從中山路一段對面望向診所所在的大樓：幾棟高樓並排，其中一棟一樓是深色外牆、掛著淺綠色招牌的店面，右側大樓一樓為巨人補習班。',
    caption: '在中山路上遠遠看，診所在高樓一樓、深色外牆掛淺綠色招牌的那一間。',
  },
  {
    src: '/assets/img/exterior-2-across.jpg',
    alt: '從對街看君禾診所門面：二樓有木色直條格柵，一樓上方是淺綠色的君禾診所招牌，騎樓旁有一座小女孩銅像，人行道上有保全公司的禁止停車立牌。',
