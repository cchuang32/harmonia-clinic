...
// 入鏡的汽機車車牌（與車內人物）要模糊處理（目前四張都沒有拍到車）。換照片時也要檢查這一點。
// ---------------------------------------------------------------------------
const exterior = [
  {
    src: '/assets/img/exterior-1-avenue.jpg',
    alt: '從中山路一段對面望向診所所在的大樓：幾棟高樓並排，其中一棟一樓是深色外牆、上方有木色直條格柵、掛著淺綠色招牌的店面，右側大樓一樓為巨人補習班。',
    caption: '在中山路上遠遠看，診所在高樓一樓、深色外牆掛淺綠色招牌的那一間。',
  },
  {
    src: '/assets/img/exterior-2-facade.jpg',
    alt: '從對街看君禾診所門面：二樓有木色直條格柵，一樓上方是淺綠色的君禾診所招牌與「君之健康 禾你同行」字樣，落地玻璃門內擺著花籃，右側有一座小女孩銅像，人行道上有保全公司的禁止停車立牌。',
...
const parkingWalk = [
  {
    src: '/assets/img/walk-1-parking.jpg',
  ...
  <div class="wrap">
    <div class="grid grid--2">
      <div>
        ...
        <p class="section-lead" style="font-size:14.5px">掛號方式、看診原則與收費說明，請見<a href="${url('/notice/')}">就醫須知</a>。</p>
      </div>
  ...
  <div class="wrap measure">
    ...
    ${site.contact.lineQr ? `<div class="line-card">
      ...
      <div class="line-card-body">
        <h3>加入 LINE 好友</h3>
        <p>LINE 線上掛號即將開放，目前請現場或電話掛號。用電腦看這一頁的話，請拿手機掃描左邊的 QR 碼；用手機看的話，直接按下面的按鈕就可以。</p>
